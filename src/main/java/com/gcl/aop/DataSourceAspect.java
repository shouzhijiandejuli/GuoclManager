...
import com.gcl.datasource.DynamicDataSource;

/**
 * 有{@link com.gcl.annotation.DataSourceChange}注解的方法，调用时会切换到指定的数据源
 * 
 * @author tanghd
 *
 */
...
public class DataSourceAspect {
    ...
    @Pointcut(value = "@annotation(com.gcl.annotation.DataSourceChange)")
